// Amorçage personnalisé, pour une seule raison : rendre l'app **dans** le
// cadre de téléphone de `index.html` plutôt que dans `<body>`. Sans
// `hostElement`, Flutter s'empare de la page entière et le cadre disparaît
// sous lui.
//
// Les deux marques entre accolades sont remplacées à la compilation par
// `flutter build web`.
...
_flutter.loader.load({
  onEntrypointLoaded: async function (engineInitializer) {
    const engine = await engineInitializer.initializeEngine({
      hostElement: document.querySelector('#screen'),
    });
    await engine.runApp();
